...
st.markdown("<h1 style='text-align: center;'>مدرسة الأردن الأساسية المختلطة</h1>", unsafe_allow_html=True)
st.markdown("<h3 style='text-align: center;'>كيف ستبدو بعد 30 سنة من التدخين؟</h3>", unsafe_allow_html=True)
